  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <KPICard label="Rakes Dispatched Today" value={kpis.today_dispatched_rakes} icon={Zap} accent="orange" />
        <KPICard label="Penalties Avoided" value={`₹${(kpis.penalties_avoided_today/100000).toFixed(1)}L`} icon={TrendingUp} accent="green" />
